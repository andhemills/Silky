...
class ControlGrid64_3_1Grid44():
	def Activated(self):
			...
			import Silky_ControlGrid64_3_1Grid44_vp
			Silky_ControlGrid64_3_1Grid44_vp.ControlGrid64_3_1Grid44_ViewProvider(a.ViewObject)
			a.ViewObject.LineWidth = 1.00
			a.ViewObject.LineColor = (170/255,170/255,255/255)
			a.ViewObject.PointSize = 2.00
			a.ViewObject.PointColor = (170/255,85/255,255/255)
...
Gui.addCommand('Silky_ControlGrid64_3_1Grid44', ControlGrid64_3_1Grid44())
