...
# get strings
tooltip = "work in progress" #(Silky_tooltips.ControlGrid64_Surf44_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = "work in progress" #(Silky_tooltips.ControlGrid64_Surf44_baseTip + Silky_tooltips.ControlGrid64_Surf44_moreInfo)
...
class ControlGrid64_Surf44():
	def Activated(self):
		...
		import Silky_ControlGrid64_Surf44_vp
		Silky_ControlGrid64_Surf44_vp.ControlGrid64_Surf44_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGrid64_Surf44', ControlGrid64_Surf44())
