...
class ControlGrid3Star66_3Sub():
	def Activated(self):
		...
		a=FreeCAD.ActiveDocument.addObject("Part::FeaturePython","ControlGrid3Star66_3Sub_000")
		AN.ControlGrid3Star66_3Sub(a,SubList)
		import Silky_ControlGrid3Star66_3Sub_vp
		Silky_ControlGrid3Star66_3Sub_vp.ControlGrid3Star66_3Sub_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGrid3Star66_3Sub', ControlGrid3Star66_3Sub())
