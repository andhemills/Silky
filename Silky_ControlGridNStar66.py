...
class ControlGridNStar66():
	def Activated(self):
		...
		if N == 1:
			...
			import Silky_ControlGridNStar66_vp
			Silky_ControlGridNStar66_vp.ControlGridNStar66_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGridNStar66', ControlGridNStar66())
