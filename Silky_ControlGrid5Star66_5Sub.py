...
class ControlGrid5Star66_5Sub():
	def Activated(self):
		...
		a=FreeCAD.ActiveDocument.addObject("Part::FeaturePython","ControlGrid5Star66_5Sub_000")
		AN.ControlGrid5Star66_5Sub(a,SubList)
		import Silky_ControlGrid5Star66_5Sub_vp
		Silky_ControlGrid5Star66_5Sub_vp.ControlGrid5Star66_5Sub_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGrid5Star66_5Sub', ControlGrid5Star66_5Sub())
