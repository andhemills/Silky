...
# get strings
tooltip = (Silky_tooltips.ControlPoly6_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.ControlPoly6_baseTip + Silky_tooltips.ControlPoly6_moreInfo)
...
class ControlPoly6():
	def Activated(self):
		...
		if mode == '5L':
			...
			import Silky_ControlPoly6_vp
			Silky_ControlPoly6_vp.ControlPoly6_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlPoly6', ControlPoly6())
