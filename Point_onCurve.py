...
# get strings
tooltip = (Silk_tooltips.Point_onCurve_baseTip + Silk_tooltips.standardTipFooter)
moreInfo = (Silk_tooltips.Point_onCurve_baseTip + Silk_tooltips.Point_onCurve_moreInfo)
