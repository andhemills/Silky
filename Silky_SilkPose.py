...
# get strings
tooltip = (Silky_tooltips.SilkPose_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.SilkPose_baseTip + Silky_tooltips.SilkPose_moreInfo)
...
class SilkPose():
	def Activated(self):
		...
		import Silky_SilkPose_vp
		Silky_SilkPose_vp.SilkPose_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_SilkPose', SilkPose())
