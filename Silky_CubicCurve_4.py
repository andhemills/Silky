...
# get strings
tooltip = (Silky_tooltips.CubicCurve_4_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.CubicCurve_4_baseTip + Silky_tooltips.CubicCurve_4_moreInfo)
...
class CubicCurve_4():
	def Activated(self):
		...
		if len(sel)==1:
			...
			import Silky_CubicCurve_4_vp
			Silky_CubicCurve_4_vp.CubicCurve_4_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_CubicCurve_4', CubicCurve_4())
