...
# get strings
tooltip = (Silky_tooltips.ControlGrid44_Rotate_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.ControlGrid44_Rotate_baseTip + Silky_tooltips.ControlGrid44_Rotate_moreInfo)
...
class ControlGrid44_Rotate():
	def Activated(self):
		...
		if mode=='4sided':
			...
			import Silky_ControlGrid44_Rotate_vp
			Silky_ControlGrid44_Rotate_vp.ControlGrid44_Rotate_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGrid44_Rotate', ControlGrid44_Rotate())
