...
# get strings
tooltip = (Silky_tooltips.ControlPoly4_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.ControlPoly4_baseTip + Silky_tooltips.ControlPoly4_moreInfo)
...
class ControlPoly4():
	def Activated(self):
		...
		if mode=='3L':
			...
			import Silky_ControlPoly4_vp
			Silky_ControlPoly4_vp.ControlPoly4_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlPoly4', ControlPoly4())
