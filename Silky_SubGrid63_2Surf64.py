...
class SubGrid63_2Surf64():
	def Activated(self):
		...
		import Silky_SubGrid63_2Surf64_vp
		Silky_SubGrid63_2Surf64_vp.SubGrid63_2Surf64_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_SubGrid63_2Surf64', SubGrid63_2Surf64())
