...
# get strings
tooltip = (Silky_tooltips.ControlGrid44_EdgeSegment_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.ControlGrid44_EdgeSegment_baseTip + Silky_tooltips.ControlGrid44_EdgeSegment_moreInfo)
...
class ControlGrid44_EdgeSegment():
	def Activated(self):
		...
		import Silky_ControlGrid44_EdgeSegment_vp
		Silky_ControlGrid44_EdgeSegment_vp.ControlGrid44_EdgeSegment_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGrid44_EdgeSegment', ControlGrid44_EdgeSegment())
