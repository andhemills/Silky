...
from SilkyNURBS import equalVectors
...
class ControlGrid64_normal():
	def Activated(self):
			...
			import Silky_ControlGrid64_normal_vp
			Silky_ControlGrid64_normal_vp.ControlGrid64_normal_ViewProvider(a.ViewObject)
...
Gui.addCommand('Silky_ControlGrid64_normal', ControlGrid64_normal())
