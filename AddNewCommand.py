...
# get strings
tooltip = (Silky_tooltips.AddNewCommand_baseTip + Silky_tooltips.standardTipFooter)
moreInfo = (Silky_tooltips.AddNewCommand_baseTip + Silky_tooltips.AddNewCommand_moreInfo)
...
Gui.addCommand('Silky_AddNewCommand', AddNewCommand())
